...
def upgrade() -> None:
    ...
    sa.Column('type_of_category', sa.Enum('INCOME', 'EXPENSE', name='typesofcat'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default='NOW()', nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default='NOW()', nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_categories_type_of_category'), 'categories', ['type_of_category'], unique=False)
